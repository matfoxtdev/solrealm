...
import { WalletManager } from "../Solana/WalletManager";
...
export class GameController {
    ...
    constructor(app) {
        ...
        this.walletManager = new WalletManager(app.config.solanaRpcUrl);
    ...
    async initializeGameData() {
        ...
        console.log("[SolRealm] loaded game data", this._gameData);
    }
    ...
    public async login(username, password) {
        ...
        if (req.status === 200) {
            ...
            localStorage.setItem("solrealm_token", req.data.user.token);
